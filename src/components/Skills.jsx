...
const Skills = () => {
  ...
  const SCATS = ['All', 'Programming', 'Frontend', 'Backend', 'Database', 'Tools', 'Soft Skills'];
  const SKILLS_DATA = [
    {n:'Java',i:'java',c:'Programming'},{n:'JavaScript',i:'js',c:'Programming'},
    {n:'C++',i:'cpp',c:'Programming'},{n:'Python',i:'py',c:'Programming'},{n:'PHP',i:'php',c:'Programming'},
    {n:'React.js',i:'react',c:'Frontend'},{n:'HTML5',i:'html',c:'Frontend'},
    {n:'Tailwind CSS',i:'tailwind',c:'Frontend'},{n:'Node.js',i:'nodejs',c:'Backend'},
    {n:'MySQL',i:'mysql',c:'Database'},{n:'MongoDB',i:'mongodb',c:'Database'},
    {n:'VS Code',i:'vscode',c:'Tools'},{n:'Problem Solving',i:'🧠',c:'Soft Skills'},
    {n:'Growth Mindset',i:'🌱',c:'Soft Skills'},{n:'Communication',i:'💬',c:'Soft Skills'},
    {n:'Adaptability',i:'🔄',c:'Soft Skills'}
  ];

...
const AboutLayout = () => {
  ...
  return (
    <section id="about" className="about-section">
      ...
      <div className="about-bg-text">RAJIV</div>
      ...
      <div className="about-main-grid">
        ...
        <div className="glass-card powerful-bio-card rv-l">
          ...
          <div className="bio-stanzas-powerful">
            <p>I'm <b>Rajiv Kumar Singh</b>, a Computer Science undergraduate at <b>Lovely Professional University</b> (CGPA 7.31) with a strong focus on <b>software development and problem solving</b>. My foundation comes from <b>data structures, algorithms, and competitive programming</b>, which trained me to think about efficiency, scalability, and clean logic in every solution I build.</p>
          ...
          <div className="powerful-stats">
            <div className="p-stat">
              <span className="p-stat-val">7.31</span>
              <span className="p-stat-label">CGPA</span>
            </div>
            <div className="p-stat">
              <span className="p-stat-val">1500+</span>
              <span className="p-stat-label">LeetCode Rating</span>
            </div>
            <div className="p-stat">
              <span className="p-stat-val">100-Day</span>
              <span className="p-stat-label">LeetCode Badge</span>
            </div>
            <div className="p-stat">
          ...
          <div className="glass-card facts-glass rv-r">
            ...
            <div className="fact-p-grid">
              {[
                ...
                {l:'Email', v:'rajivsinghrajput146@gmail.com', i:'📧'}
              ].map((f,i)=>(

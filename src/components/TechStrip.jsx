...
const TechStrip = () => {
  const STACK1 = [
    {n:'React JS',i:'react'},{n:'Node.js',i:'nodejs'},{n:'MongoDB',i:'mongodb'},{n:'Express',i:'express'},
    {n:'Java',i:'java'},{n:'JavaScript',i:'js'},{n:'Python',i:'py'},{n:'Tailwind',i:'tailwind'}
  ];
  const STACK2 = [
    {n:'MySQL',i:'mysql'},{n:'Socket.io',i:'socketio'},{n:'PHP',i:'php'},{n:'C++',i:'cpp'},
    {n:'Git',i:'git'},{n:'Postman',i:'postman'},{n:'HTML5',i:'html'},{n:'CSS3',i:'css'}
  ];
    ...
    <div className="tech-strip-wrapper">
      ...
      <div className="marquee-container mt-4">
        <div className="marquee-content right">
          {doubled2.map((t, i) => (
            <div key={i} className="tech-item-premium alternate">
              <img src={`https://skillicons.dev/icons?i=${t.i}`} alt={t.n} className="tech-img-p" />
              <span className="tech-name-p">{t.n}</span>
            </div>
          ))}
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .tech-item-premium:hover {
          ...
          box-shadow: 0 10px 30px rgba(0, 220, 255, 0.15);
        }
        .tech-img-p {
          width: 32px;
          height: 32px;
